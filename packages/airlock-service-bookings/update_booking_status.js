...
(async () => {
  ...
  // airlock-service-bookings with checkOutDate before today's date should be set to status COMPLETED
  try {
    ...
    if (completedBookings > 0) {
      ...
      // airlock-service-bookings where today's date falls within checkInDate and checkOutDate range should be updated to CURRENT
